...
function change(){
        ...
        $code1 = request('/go-promotions/v1/promotions/enrollments', $token, '{"promo_code":"GOFOOD160420A"}');
        $message = fetch_value($code1,'"message":"','"');
        if(strpos($code1, 'Promo kamu sudah bisa dipakai.')){
        echo "\n".color("green",">] Message: ".$message);
        goto gofood;
        ...
        $code1 = request('/go-promotions/v1/promotions/enrollments', $token, '{"promo_code":"GOFOOD160420B"}');
        $message = fetch_value($code1,'"message":"','"');
        echo "\n".color("green",">] Message: ".$message);
        ...
        sleep(5);
        $boba09 = request('/go-promotions/v1/promotions/enrollments', $token, '{"promo_code":"GOFOOD160420A"}');
